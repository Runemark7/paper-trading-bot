...
| GET    | `/api/discovery/summary` | Last-known unique-tested / in-flight (2 names / ~120s cycle slice) / leftover-untested; rejected parked forever; empty eligible auto-refills `discovery_extended.json`; newest last_tested_at; stuck/stale copy |
