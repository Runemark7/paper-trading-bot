...
| GET    | `/api/discovery/summary` | Last-known unique-tested / in-flight (1 name / ~90s cycle slice) / leftover-untested; rejected parked forever; newest last_tested_at; stuck/stale copy |
