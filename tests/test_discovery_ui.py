...
class DiscoveryPageContractTests(unittest.TestCase):
    ...
    def test_champions_keeps_teaser_not_full_buckets(self):
        ...
        self.assertIn("queryFn: () => fetchDiscoverySummary()", DISCOVERY_TSX)
        self.assertIn("useQuery<DiscoverySummary, Error>", DISCOVERY_TSX)
        self.assertNotIn("queryFn: fetchDiscoverySummary,", DISCOVERY_TSX)
    ...
    def test_farm_control_start_stop_and_unseen_copy(self):
        ...
        self.assertIn('queryKey: ["discovery-summary", "compact"]', FARM_TSX)
        self.assertIn("queryFn: () => fetchDiscoverySummary({ compact: true })", FARM_TSX)
        self.assertIn("useQuery<DiscoverySummary, Error>", FARM_TSX)
        self.assertNotIn("queryFn: fetchDiscoverySummary,", FARM_TSX)
