...
class GraduatedPaperTokenTests(unittest.TestCase):
    ...
    def test_constants_match_protocol_cited_values(self):
        ...
        self.assertLess(constants.DISCOVER_CYCLE_MAX_NAMES, 4)
        self.assertLess(constants.DISCOVER_CYCLE_TIME_BUDGET_SECONDS, 150)
    ...
    def test_nginx_does_not_proxy_run(self):
        ...
        self.assertIn("location /api/", tmpl)
        self.assertNotIn("location = /api/discovery/ingest", tmpl)
        self.assertIn("proxy_read_timeout    90s", tmpl)
        self.assertIn("proxy_send_timeout    90s", tmpl)
    ...
    def test_kustomization_has_no_cronjob(self):
        ...
        self.assertIn("DISCOVERY_ON_CYCLE", backend)
        self.assertIn("PAPER_DISCOVERY_MODE", backend)
        self.assertIn("paper-discovery-ingest", backend)
        ...
        self.assertIn("DISCOVERY_ON_CYCLE", compose)
